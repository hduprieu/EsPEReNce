# Resource URL: https://developers.facebook.com/docs/graph-api/reference/canvas/
Canvas
======
...
# Resource URL: https://developers.facebook.com/docs/graph-api/reference/canvas-footer/
Canvas Footer
=============
